...
public:
    LifetimeCounter() { _inc(); }

    explicit LifetimeCounter(bool doCount): __LifetimeCounterBase{ doCount } {
        _inc();
    }

    LifetimeCounter(LifetimeCounter const& rhs) { _inc(); }

    LifetimeCounter(LifetimeCounter&&) noexcept { _inc(); }

    ~LifetimeCounter() { _dec(); }

    LifetimeCounter& operator=(LifetimeCounter const&) { return *this; }

    LifetimeCounter& operator=(LifetimeCounter&&) noexcept { return *this; }
