...
[[maybe_unused]] static format_codes::format_code_array logLevelFormat(log_level l) {
    switch (l) {
    case log_level::trace: return format_codes::gray | format_codes::bold;
    case log_level::info: return format_codes::green | format_codes::bold;
    case log_level::debug: return format_codes::blue | format_codes::bold;
    case log_level::warning: return format_codes::dark_yellow | format_codes::bold;
    case log_level::error: return format_codes::red | format_codes::bold;
    case log_level::fatal: return format_codes::background_red | format_codes::light_gray | format_codes::bold;
    default: __utl_debugfail("invalid log_level");
    }
}
...
[[maybe_unused]] static format_codes::format_code_array logLevelMessageFormat(log_level l) {
    return [&]() -> format_codes::format_code_array {
        switch (l) {
        case log_level::trace: return format_codes::gray;
        case log_level::info: return format_codes::green;
        case log_level::debug: return format_codes::blue;
        case log_level::warning: return format_codes::dark_yellow;
        case log_level::error: return format_codes::red;
        case log_level::fatal: return format_codes::background_red | format_codes::bold | format_codes::light_gray;
        default: __utl_debugfail("invalid log_level");
        }
    }() | format_codes::italic;
}
