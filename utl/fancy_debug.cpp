...
namespace utl {
												   ...
												   char const* message) _UTL_NORETURN
	{
		...
		char const* kind_str = [&]{
			switch (kind) {
				case __utl_assertion_kind::assertion:
					return "Assertion";
				case __utl_assertion_kind::precondition:
					return "Precondition";
				case __utl_assertion_kind::postcondition:
		...
		utl::print("{}{}:{} {}{} failed{}: {}{}{} \n"
				   ...
				   "\t[{}{}{}]\n"
				   "was not satisfied{}{}{}{}{}\n\n",
				   format_codes::gray, module_name, format_codes::reset,
				   ...
				   format_codes::italic, data.function,
				   format_codes::reset | format_codes::gray,
				   data.line,
