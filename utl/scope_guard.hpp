...
public:
    ...
    constexpr void execute() noexcept requires(Armed == true) {
        __f();
        this->__armed = false;
    }
};
...
#define utl_defer ::utl::scope_guard UTL_ANONYMOUS_VARIABLE(__utl_scope_guard_state_) = [&]() -> void
#define utl_defer_failure                                                                                              \
    ::utl::scope_guard_failure UTL_ANONYMOUS_VARIABLE(__utl_scope_guard_state_) = [&]() noexcept -> void
#define utl_defer_success ::utl::scope_guard_success UTL_ANONYMOUS_VARIABLE(__utl_scope_guard_state_) = [&]() -> void
