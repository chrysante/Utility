...
namespace utl_test {
	...
	public:
		FuzzyAlignmentResource(utl::pmr::memory_resource* upstream = utl::pmr::get_default_resource()):
			_upstream(upstream)
		{}
	...
	private:
		void* do_allocate(std::size_t size, std::size_t alignment) override {
			...
			std::byte* const allocation = (std::byte*)_upstream->allocate(size * 2, alignment);
	...
	private:
		...
		utl::hashmap<void*, void*> _allocations; // maps results to actual internal allocations
	};
