...
#define TYPE_LIST(O) \
(int, 2, O), (int, 3, O), (int, 4, O), \
(unsigned, 2, O), (unsigned, 3, O), (unsigned, 4, O), \
(float, 2, O), (float, 3, O), (float, 4, O), \
(double, 2, O), (double, 3, O), (double, 4, O), (double, 7, O), (double, 8, O) \

#define VECTOR_TEST_CASE(...) \
TEMPLATE_TEST_CASE_SIG(__VA_ARGS__, \
					   ((typename T, std::size_t Size, mtl::vector_options Options), T, Size, Options), \
