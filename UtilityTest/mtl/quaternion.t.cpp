...
TEST_CASE("quaternion multiplication") {
	...
	SECTION("quaternion * quaternion") {
		mtl::quaternion<int> const b = { 2, 3, 4, 1 };
		mtl::quaternion<int> const ref = { -20, -6, 20, 8 };
		CHECK(a * b == ref);
	}
	SECTION("quaternion * complex") {
		mtl::complex<int> const b = { 2, 3 };
		mtl::quaternion<int> const ref = { -4, 7, 18, -1 };
		CHECK(a * b == ref);
	}
	SECTION("complex * quaternion") {
		mtl::complex<int> const b = { 2, 3 };
		mtl::quaternion<int> const ref = { -4, 7, -6, 17 };
		CHECK(b * a == ref);
	}
}

TEMPLATE_TEST_CASE("quaternion math function", "[quaternion]", float, double, long double) {
	SECTION("exponential") {
	...
	SECTION("trigonometric") {
		...
		SECTION("sin") {
			mtl::quaternion<TestType> const ref = {
			...
			CHECK(mtl::sin(1 + 1_i + 0_j) == mtl::approx(ref));
		}
		SECTION("cos") {
			mtl::quaternion<TestType> const ref = {
			...
			CHECK(mtl::cos(1 + 1_i + 0_j) == mtl::approx(ref));
		}
		SECTION("tan") {
			mtl::quaternion<TestType> const ref = {
			...
			CHECK(mtl::tan(1 + 1_i + 0_j) == mtl::approx(ref));
		}
		...
		SECTION("sinh") {
			...
			CHECK(mtl::sinh(1 + 1_i + 0_j) == mtl::approx(ref));
		}
		...
		SECTION("cosh") {
			...
			CHECK(mtl::cosh(1 + 1_i + 0_j) == mtl::approx(ref));
		}
		...
		SECTION("tanh") {
			...
			CHECK(mtl::tanh(1 + 1_i + 0_k) == mtl::approx(ref));
		}
