...
requires requires(Selector&& s, SizeConstant c) {
    s(c);
} &&(__is_integral_constant<SizeConstant>::value) void __dispatch_one_impl(Selector&& selector,
                                                                           SizeConstant size_constant,
                                                                           std::size_t index,
                                                                           auto&&... args) {
...
template <class T>
void dispatch(__dispatch_arg<T> const& a, std::invocable<typename __dispatch_arg<T>::__test_type> auto&& selector) {
...
void dispatch(
    ...
    std::invocable<typename __dispatch_arg<T>::__test_type, typename __dispatch_arg<U>::__test_type> auto&& selector) {
