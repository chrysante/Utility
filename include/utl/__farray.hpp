...
template <typename AxisSizes,
          ...
          typename FlatI = std::make_index_sequence<__idx_seq_product(AxisSizes{})>>
struct __farray_base_impl;

template <std::size_t... AxisSizes>
struct __farray_base: __farray_base_impl<std::integer_sequence<std::size_t, AxisSizes...>> {};
                          ...
                          std::index_sequence<FlatI...>>
{
    ...
    static constexpr std::array<std::size_t, __dim> __axis_sizes = { AxisSizes... };
    ...
    static constexpr std::array<std::size_t, __dim> __expand_index(std::size_t flat_index) {
    ...
    template <typename R, typename F, typename... T, typename ConcreteTypeGetter>
    constexpr auto __make(ConcreteTypeGetter) { return __make_impl<ConcreteTypeGetter, R, F, T...>::call(); }
};
...
struct __farray<R, F, type_sequence<T...>, AxisSizes>: __farray_base_impl<AxisSizes> {
    ...
    __visit_fn operator[](std::array<std::size_t, __dim> const& index) const { return __data[__base::__flatten_index(index)]; }
