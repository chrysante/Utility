...
constexpr auto operator"" _format(const wchar_t *s, size_t n) -> detail::udl_formatter<wchar_t> { return {{s, n}}; }
...
FMT_DEPRECATED auto format_to(basic_memory_buffer<Char, SIZE, Allocator> &buf, const S &format_str, Args &&...args) ->
...
template <typename OutputIt, typename Locale, typename S, typename... Args, typename Char = char_t<S>,
